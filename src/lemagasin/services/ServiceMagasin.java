...
/**
 * Service de l'application LeMagasin. Cette classe permet de donner gérer le
 * magasin.
 * 
...
public class ServiceMagasin {
    ...
    /**
     * Constructeur du service Magasin. Ici il crée ses deux attributs leMagasin et
     * serviceDate.
     */
    ...
    /**
     * Cette méthode demande à leMagasin d'ajouter un article. Elle récupère le
     * retour
     * boolean de cette méthode et le transfert en retour à Ctrl.
     * 
     * @param unArticleStock instance d'ArticleStock représentant un article du
     *                       stock à ajouter.
    ...
    /**
     * Cette méthode demande à leMagasin de lui donner la liste des articles du
     * stock.
    ...
    /**
     * Cette méthode demande à leMagasin de lui retourner le nombre de genre
     * d'article en stock.
    ...
    /**
     * Cette méthode demande à leMagasin de lui retourner le nombre maximum de genre
     * d'article du stock.
     * Elle le retournera à ctrl directement.
     * 
    ...
    /**
     * Cette méthode demande à leMagasin de lui retourner le nombre d'éléments
     * (articles)
    ...
    /**
     * Cette méthode demande à leMagasin de lui retourner le nombre maximum
     * d'éléments
    ...
    /**
     * Cette méthode demande à laMagasin de lui retourner tous les genres d'article
     * du stock dans un tableau de String.
     * 
    ...
    /**
     * Cette méthode demande à leMagasin d'ajouter un article (instance
     * d'ArticleVente) à la facture.<BR>
     * Ensuite elle demande à leMagasin de diminuer le stock en fonction du nombre
     * d'article vendus.<BR>
     ...
     *                  nombre vendu (nbr) et un Article (composé lui même du genre
     *                  et du prix unitaire).<BR>
     * 
     ...
     * 
     * @return String[] un tableau de String contenant pour chaque String une ligne
     *         de la facture.
     */
    ...
    /**
     * Cette méthode demande à wrkDate de lui retourner la date du jour
     * (dateCourante)
    ...
    public String donneDateDuJour() {
        String laDateDuJour = serviceDate.donneDateCourante();
        return laDateDuJour;
    }

    /**
     * Cette méthode demande à leMagasin de creer une nouvelle facture. leMagasin
     * lui retournera alors le montant de la caisse, elle le récuperera et le
     * transmettra
